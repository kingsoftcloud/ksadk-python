...
- **Hosted/local UI 真源收敛**：`@kingsoftcloud/ksadk-web@0.2.8` 已发布到 npm，本地 `agentengine web` 静态资源默认从 `@kingsoftcloud/ksadk-web@latest` 的 `dist-ksadk` 同步；共享 UI 源码只在 `ksadk-web` 维护。
