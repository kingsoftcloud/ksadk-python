...
<p align="center">
  <strong>一次构建 Agent，到处运行。</strong>
</p>

<p align="center">
  面向 AI Agent 的运行时平台（Agent Runtime Platform）。继续使用 Google ADK、LangGraph、LangChain 或 DeepAgents 编写业务 Agent，再用统一 CLI、Web UI、OpenAI-Compatible API、工具运行时、沙箱、部署和可观测链路把它跑起来。
</p>
...
<p align="center">
  <a href="public-docs/assets/ksadk-runtime-platform-hero.png">
    <img alt="KsADK 真实 CLI 截图：agentengine -h" src="public-docs/assets/ksadk-runtime-platform-hero-wide.png" width="860" />
  </a>
</p>
