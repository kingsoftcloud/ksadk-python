...
<p align="center"><a href="docs-site/public/assets/ksadk-runtime-platform-hero.png"><img alt="KsADK 0.8.4 AgentKit Studio 真实 Agent 工作区" src="docs-site/public/assets/ksadk-runtime-platform-hero-wide.png" width="860" /></a></p>
...
KsADK 0.8.4 把“框架适配”收敛为稳定的运行时分层，同时保留各框架的原生执行语义：
...
<p align="center"><img alt="KsADK 0.8.4 Studio 知识库、记忆库与 Skill Center 真实绑定界面" src="docs-site/public/assets/ksadk-web-ui-screenshot.png" width="860" /></p>

<p align="center"><img alt="KsADK 0.8.4 Studio Agent、资源绑定与插件页真实演示" src="docs-site/public/assets/ksadk-local-debugging-demo.gif" width="860" /></p>
...
<p align="center"><img alt="KsADK 总体技术架构" src="docs-site/public/assets/ksadk-runtime-architecture.png" width="860" /></p>
