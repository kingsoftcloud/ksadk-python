...
const copy = {
  cn: {
    ...
    subtitle: "金山云智能体开发套件",
    desc: "构建、部署、调试、观测企业级 AI 智能体的一站式云原生框架。0.8.5 以可信内核、Harness 执行层和可插拔 Provider 统一 Codex、ADK、LangGraph 等运行时。",
    cta: "阅读文档",
  ...
  en: {
    ...
    desc: "A cloud-native framework to build, deploy, debug, and observe enterprise AI agents. Version 0.8.5 unifies Codex, ADK, LangGraph, and other runtimes through a trusted kernel, Harness execution layer, and pluggable Providers.",
    cta: "Read the docs",
    ctaSecondary: "GitHub",
...
export default async function HomePage({
  ...
  return (
    <main className="relative flex flex-1 flex-col items-center justify-center text-center px-4 py-24 overflow-hidden">
      ...
      <p className="text-xl font-semibold text-fd-foreground mb-2 relative">
        {t.subtitle}
      </p>
      <p className="max-w-2xl text-fd-muted-foreground mb-8 relative">
        {t.desc}
      </p>
      <div className="flex flex-wrap items-center justify-center gap-3 mb-8 relative">
        <Link
          ...
          style={{
            background: "linear-gradient(135deg, #5368db 0%, #59d3d9 100%)",
          }}
        >
          {t.cta}
        </Link>
      ...
      <div className="w-full max-w-md relative">
        <p className="text-sm text-fd-muted-foreground mb-1.5 text-left">
          {t.installLabel}
        </p>
        <ServerCodeBlock
          lang="bash"
