...
`studio/static` contains the packaged React production build. Frontend sources
and tests live in `ksadk/studio/react-ui`; run `make studio-react-test` after
changing them to rebuild and verify the packaged assets.
