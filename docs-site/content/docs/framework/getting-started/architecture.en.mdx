...
For implementation details, see [Runtime Architecture](../guides/runtime-architecture). For plugin, Provider, and scheduled-task configuration, see [Plugins and Automations](../guides/plugins-and-automations).
