...
flowchart TD
  ...
  subgraph flow["multi-turn orchestration"]
    Plan
    Specialist
    Final
  end
  subgraph tools["specialist toolset"]
    KB
    Mem
    Skills
    MCP
  ...
  class User,Final brand
  class Plan,Specialist accent
  class KB,Mem,Skills,MCP,Workspace neutral
```
