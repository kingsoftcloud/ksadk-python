...
Studio binds to `127.0.0.1:7831` by default. The command prints a local session URL and opens it in the browser. That URL is for local use only: do not share its `#session=...` fragment.
