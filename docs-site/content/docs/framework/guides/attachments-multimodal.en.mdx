...
![Attachment normalization flow](/assets/ksadk-attachment-normalization.svg)
...
![Session attachment carryover](/assets/ksadk-attachment-session-carryover.svg)
...
![Resume after refresh](/assets/ksadk-attachment-refresh-resume.svg)
