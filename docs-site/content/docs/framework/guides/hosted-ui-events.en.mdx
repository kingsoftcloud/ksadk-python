...
KsADK 0.8.5 separates Hosted UI transport, interactive presentation,
...
<Callout type="warning" title="Release boundary">
This page describes interfaces and boundaries in the 0.8.5 candidate source. It does not claim that this candidate has completed npm/PyPI publication. A real hosted deployment must still validate its gateway, authentication, runner, database, and provider credentials.
</Callout>
...
For browser debugging, see [Local Web UI](./local-web-ui.mdx). For session and checkpoint semantics, see [Sessions, Runtime, and Files](../../references/runtime-sessions-files.mdx).
