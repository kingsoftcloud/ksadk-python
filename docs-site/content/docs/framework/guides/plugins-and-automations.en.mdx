...
The universal Python wheel includes Web 0.3.5 and built Studio pages. It does not include Python dependencies, Node/Codex/DSH binaries, community plugins or credentials. Use the framework extra you need; a fully disconnected installation also requires a prepared dependency wheelhouse and any native toolchains. Existing cloud Agents are unchanged until explicitly rebuilt and redeployed.
