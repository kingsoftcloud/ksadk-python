...
| --- | --- | --- |
| `KSADK_WEB_VERSION` | `0.2.19` | published npm package version; release candidates must pin a concrete version, e.g. `0.3.0` |
...
<Callout type="info" title="0.6.7 release record example">
- `ksadk-python`: `0.6.7`
