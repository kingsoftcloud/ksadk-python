...
- [Frameworks](../guides/frameworks.mdx): ADK runner behavior and detection order.
- [Agent Best Practices](./best-practices/agent-best-practices.mdx): ADK, memory, knowledge, MCP, and Skill Runtime patterns.
- [Environment Variables](/en/docs/references/environment-variables): model, memory, knowledge, MCP, and tracing variables.
- [OpenAI-Compatible API](/en/docs/references/openai-compatible-api): local protocol shape.
