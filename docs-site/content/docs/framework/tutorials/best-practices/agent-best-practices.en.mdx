...
![plan_turn routing and orchestration](/assets/ksadk-plan-turn-routing.svg)
...
These examples apply the patterns above to real scenarios:

<Cards>
  <Card title="LangGraph + AgentEngine Toolsets" href="/en/docs/framework/tutorials/best-practices/langgraph-toolsets">
    A real demo combining a LangGraph outer graph with AgentEngine Toolsets.
  </Card>
  <Card title="Long-Task Resume Agent" href="/en/docs/framework/tutorials/best-practices/long-task-resume">
    A real demo of an agent that resumes long-running tasks.
  </Card>
  <Card title="Custom UI Agent Hosting Tutorial" href="/en/docs/framework/tutorials/best-practices/custom-ui-agent">
    A tutorial for hosting a custom-UI agent on AgentEngine.
  </Card>
  <Card title="ksadk-samples Repository" href="https://github.com/kingsoftcloud/ksadk-samples">
    The GitHub samples repository, grouped by scenario.
  </Card>
</Cards>
