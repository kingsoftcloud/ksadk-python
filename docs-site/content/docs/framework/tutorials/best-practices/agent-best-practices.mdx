...
![plan_turn 路由与编排](/assets/ksadk-plan-turn-routing.svg)
...
<Cards>
  <Card title="LangGraph + AgentEngine Toolsets" href="/cn/docs/framework/tutorials/best-practices/langgraph-toolsets">
    LangGraph 外层图 + AgentEngine Toolsets 的真实 demo。
  </Card>
  <Card title="长任务恢复 Agent" href="/cn/docs/framework/tutorials/best-practices/long-task-resume">
    长任务断点恢复 Agent 的真实 demo。
  </Card>
  <Card title="自定义 UI Agent 托管教程" href="/cn/docs/framework/tutorials/best-practices/custom-ui-agent">
    自定义 UI Agent 托管到 AgentEngine 的教程。
  </Card>
