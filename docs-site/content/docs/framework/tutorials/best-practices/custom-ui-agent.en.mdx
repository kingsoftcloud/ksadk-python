...
<Cards>
  <Card title="Local Web UI" href="/en/docs/framework/guides/local-web-ui">
    Custom bundle auto-detection, streaming fixes, and common-failure troubleshooting.
  </Card>
  <Card title="Build and package" href="/en/docs/framework/guides/build-and-package">
    How the serverless image build packages `research-ui/dist` into the artifact, and UI config env injection details.
  </Card>
  <Card title="Long-task resume and Deep Research continuation" href="/en/docs/framework/tutorials/best-practices/long-task-resume">
