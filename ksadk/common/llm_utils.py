...
# But for "smart switching based on public URL", we might need to know
# what to switch TO,
...
# Strategy: If Public URL + Internal Env -> Unset OPENAI_BASE_URL,
# letting it fall back to the platform default.
...
def get_smart_openai_env() -> None:
    ...
    This prevents network hangs caused by accessing public endpoints from
