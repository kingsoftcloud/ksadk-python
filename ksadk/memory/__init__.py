...
def __getattr__(name):
    ...
    _v2_names = {
        "MemoryRecord", "MemoryCandidate", "MemorySearchRequest", "MemorySearchResult",
        "MemoryCapabilities", "CoreMemoryBlock", "MemoryDeleteRequest", "MemoryDeleteResult",
        "MemoryProvider", "MemoryPolicy", "MemoryCoordinator", "MemoryExtractor",
        "SqliteMemoryProvider", "build_search_request", "recall_to_context_item",
        "propose_memory_candidates",
    }
    if name in _v2_names:
        if name in {"MemoryRecord", "MemoryCandidate", "MemorySearchRequest", "MemorySearchResult",
                    "MemoryCapabilities", "CoreMemoryBlock", "MemoryDeleteRequest", "MemoryDeleteResult"}:
