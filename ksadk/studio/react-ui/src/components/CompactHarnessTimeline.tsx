...
export function CompactHarnessTimeline({ messages, sessionId, activeRunId, hasMoreMessages = false, onLoadOlderSessionMessages, onOpenSession, className, ...props }: Props) {
