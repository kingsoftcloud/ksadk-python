    ...
    def _export_trace(self, trace_id: str, spans):
        ...
        for span in spans:
            ...
            if hasattr(span, "parent") and span.parent:
                ...
                and hasattr(span.context, "is_remote")
                and span.context.is_remote
            ):
        ...
        # Preserve the OTEL trace ID across manual and auto-instrumented spans.
        ...
        span_user_id = (
            attrs.get("langfuse.user.id") or attrs.get("langfuse.user_id") or attrs.get("user.id")
        )
        ...
        try:
            ...
            if agent_config:
                ...
                if (
                    agent_config.agent_name and root_span == spans[0]
                ):  # Rough check if it's main Span
