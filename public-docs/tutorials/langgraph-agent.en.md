...
- Add framework-specific patterns from [Frameworks](../guides/frameworks.en.md).
- Add session or file handling from [Runtime Sessions And Files](../reference/runtime-sessions-files.en.md).
- Package the project with [Build And Package](../guides/build-and-package.en.md).
