...
def test_trace_records_planned_projected_actual():
    ...
    span = _FakeSpan()
    plan = {
        "plan_id": "p1", "planned_input_tokens": 12000,
...
def test_trace_records_null_projected_when_unknown():
    ...
    span = _FakeSpan()
    plan = {"plan_id": "p1", "planned_input_tokens": 100, "projected_input_tokens": None,
            "runtime_reported_input_tokens": None, "accounting_accuracy": "estimated"}
    _set_context_plan_attributes(span, plan)
...
def test_native_compaction_visibility_opaque():
    ...
    span = _FakeSpan()
    plan = {"compaction_owner": "native", "accounting_accuracy": "opaque", "integration_mode": "native_runtime"}
    _set_context_plan_attributes(span, plan)
...
def test_ksadk_compaction_no_opaque_marker():
    ...
    span = _FakeSpan()
    plan = {"compaction_owner": "ksadk", "accounting_accuracy": "exact", "integration_mode": "ksadk_hosted"}
    _set_context_plan_attributes(span, plan)
...
def test_framework_compaction_no_opaque_marker():
    ...
    span = _FakeSpan()
    plan = {"compaction_owner": "framework", "accounting_accuracy": "estimated", "integration_mode": "framework_assisted"}
    _set_context_plan_attributes(span, plan)
    assert "context.compaction_visibility" not in span.attrs
